...
1. Login to [SNOW](https://rchauprod.service-now.com/snow?id=pmcc_home) and create an IT Service Desk Request as shown [here](https://confluence.petermac.org.au/pages/viewpage.action?pageId=161024525).
...
In a browser navigate to [https://research-cluster.petermac.org.au](https://research-cluster.petermac.org.au) and enter your login, as in:

![](vignettes/images/ood_login.png)
If you see the following Unauthorized error instead of the login prompt, you will need to use the Citrix Edge Browser. 


![](vignettes/images/openondemand-error.png)
You should then see in the Open OnDemand Dashboard as in:

![](vignettes/images/ood.png)
...
packages designed for data science called the **`tidyverse`** that make it much easier and more fun to work with your data. After installing R and RStudio, follow the instructions below to
